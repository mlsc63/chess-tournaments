...
from controllers.data_controller import DataControllerErase, \
    DataControllerLoad, DataControllerSave
from list import ListObjet
from controllers.information_board_controller import \
...
class HomeMenuController:
    ...
    three parameters are sent (Key entered by the user, the message displayed,
     and the function)
    ...
    def __call__(self):
        ...
        self.menu.add(
            "auto", "Liste de tous les joueurs",
            ListOfAllPlayers())
        self.menu.add(
            "auto", "Liste de tous les tournois",
            ListOfAllTournaments())
        self.menu.add(
            "auto", "Liste de tous les tours d'un tournoi",
            ListOfAllRoundsInATournament())
        self.menu.add(
            "auto", "Liste de tous les matchs d'un tournoi",
            ListOfAllMatchesInATournament)
        self.menu.add(
            "s", "Sauvegarder",
            DataControllerSave())
